...
#pragma omp parallel private(loaded_value)
#pragma omp for schedule(dynamic,1)nowait
	for (int H = 0; H < imgHeight; H++)
	{
		for (int W = 0; W < 3 * imgWidth; W += 32)
		{
			...
			__m256i sec7_result16 = _mm256_min_epu8(sec4_result16, loaded_value[24]);
			__m256i sec7_result24 = _mm256_max_epu8(sec4_result16, loaded_value[24]);
